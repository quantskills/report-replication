...
Usage:
    python check_step5_strategy.py /home/coder/project/replication/report-replication/{report_id}
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python check_step5_strategy.py /home/coder/project/replication/report-replication/{report_id}")
        sys.exit(1)
