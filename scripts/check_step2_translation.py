...
Usage:
    python check_step2_translation.py /home/coder/project/replication/report-replication/{report_id}
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python check_step2_translation.py /home/coder/project/replication/report-replication/{report_id}")
        sys.exit(1)
